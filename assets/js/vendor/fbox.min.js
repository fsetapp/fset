...
`);var Ur=e=>{if(!e)return"";for(let t of Object.keys(e))switch(t){case P:return"N";case I:return"R";case K:return"M";case Q:return"C";case X:return"C";case Z:return"C";case Ee:return"C"}},Pe=e=>{switch(!0){case e.ui.level==e.ui.rootLevel:return tn(e);case Wt.includes(e.sch.type):return rn(e);default:return ln(e)}},tn=e=>y.for(e.sch,`${e.path}`)`
  <li id="${e.path}" .dataset="${{tag:e.ui.taggedLevel[e.ui.level]}}" .key="${e.key}" .index="${0}" aria-posinset="${1}" class="root-item" role="treeitem" aria-level="${e.ui.level}" aria-selected="false" tabindex="-1">
    ...
    <ul data-group="${Pr(e.sch)}" role="group" tabindex="-1">
      ${jr(e)}
    </ul>
  ...
  <li id="${e.path}" .dataset="${{tag:e.ui.taggedLevel[e.ui.level],diff:Ur(e.sch._diff)}}" .key="${e.key}" .index="${e.ui.index}" aria-posinset="${e.ui.index+1}" class="file" role="treeitem" aria-level="${e.ui.level}" aria-selected="false" tabindex="-1">
    ...
    ${Wr(e)}
    ${Gr(e)}
  </li>`,jr=e=>{if(e.ui.depthLimit&&e.ui.level>=e.ui.depthLimit)return y``;switch(!0){case[v].includes(e.sch.type):return nn(e);case[A].includes(e.sch.type):return on(e);case[M].includes(e.sch.type):return an(e);case[w].includes(e.sch.type):return sn(e);default:return y``}},nn=e=>e.sch.order.map((t,r)=>Pe({key:t,sch:e.sch.fields[t],parent:{type:e.sch.type,path:e.path},ui:{...e.ui,level:e.ui.level+1,index:r},path:`${e.path}[${t}]`})),on=e=>e.sch.schs.map((t,r)=>Pe({key:r,sch:e.sch.schs[r],parent:{type:e.sch.type,path:e.path},ui:{...e.ui,level:e.ui.level+1,index:r},path:`${e.path}[][${r}]`})),an=e=>Pe({key:0,sch:e.sch.sch,parent:{type:e.sch.type,path:e.path},ui:{...e.ui,level:e.ui.level+1,index:0},path:`${e.path}[][${0}]`}),sn=e=>e.sch.schs.map((t,r)=>Pe({key:"",sch:e.sch.schs[r],parent:{type:e.sch.type,path:e.path},ui:{...e.ui,level:e.ui.level+1,index:r},path:`${e.path}[][${r}]`})),at=e=>`padding-left: ${(e.ui.level-1)*1.25+e.ui.tab}rem`,qr=(e,t,r)=>y`<textarea id="${e}" class="no-resize" spellcheck="false" maxlength="255" rows="1" autofocus
  data-parent-path="${t}"
  oninput="${et}"
